...
if __name__ == '__main__':
    ...
    for player in range(1, total_player+1): # 선수 1부터 total_player까지 반복문
        ...
        heatmap_background = cv2.imread('heatmap.png')    # 히트맵창의 배경 지정
    ...
    print('\n')
    print('---------------------------------------------------------------------------------------------------')
    print('A팀 공 점유율: ', sum_ball_A, ' % (', sum_ball_A, '+', sum_ball_B, ') x 100 = ', int(ball_share_A_res), '%')
    print('B팀 공 점유율: ', sum_ball_B, ' % (', sum_ball_A, '+', sum_ball_B, ') x 100 = ', int(ball_share_B_res), '%')
    print('---------------------------------------------------------------------------------------------------')
    ##########################################################################################################
