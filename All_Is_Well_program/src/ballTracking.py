...
def track_ball(video_path) :
    ...
    cap = cv2.VideoCapture(video_path)  #비디오를 읽는 함수-길
...
if __name__ == "__main__":
    # 테스트 영상들 
    video_path = '../sample_videos/YEONSU_44s.avi'   # 연수체육관에서 찍은 영상
    # video_path = '../sample_videos/22s.mov'   # 3차 데모에서 사용한 영상 22초짜리 
    # video_path = '../sample_videos/3rd_demo.mov'   # 3차 데모에서 사용한 영상
