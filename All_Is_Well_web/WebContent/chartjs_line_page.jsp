                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                <a href="main.jsp" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Home <span class="fa fa-angle-down"></span></a>
                ...
                <nav class="nav-menu">
                    ...
                    <ul class="primary-menu">
                        ...
                        <li class="child-menu"><a href="#">My Data <i class="fa fa-angle-right"></i></a>
                            <div class="sub-menu-wrapper">
                                <ul class="sub-menu center-content">
                                    <li><a href="chartjs_line.html">선수 체력 </a></li>
...
<iframe src="chartjs_line.html" width="1500" height="1200">
