...
<body>
	...
	<%
		...
		try{
			//아이디, 이름, 비밀번호, 메일, 팀명	
			String sql = "INSERT INTO PlayerSignUpInfo(id, name, passwd, email, height, weight, age, team, mainPosition, subPosition) VALUES('" + id + "','" + name + "','"+passwd + "','" + email + "','" + height + "','" + weight + "','" + age + "','" + team + "','" + mainPosition + "','" + subPosition + "')";
