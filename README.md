...
### 드론으로 촬영한 풋살 경기 영상을 영상처리 기술로 분석하여 선수 개인의 데이터부터 경기 데이터까지 다양하고 의미 있는 데이터를 추출하여 시각화한다.&nbsp; 또한 감독 모드를 통해 선수들의 컨디션 관리와 경기 내용 등 팀 운용 하는데 유용하게 쓰일 수 있다.
...
#### 정수경  
  - 서버 및 DB 구축
  - 웹페이지 개발: 선수UI, 감독UI, 데이터 그래프로 시각화 모듈     
